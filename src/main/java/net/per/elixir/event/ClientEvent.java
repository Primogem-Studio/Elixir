...
public class ClientEvent {
    ...
    private static void onRegisterAdditionalModels(ModelEvent.RegisterAdditional event) {
        event.register(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(MOD_ID, "block/empty"), "standalone"));
        ...
        event.register(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(MOD_ID, "block/xuanyang"), "standalone"));
